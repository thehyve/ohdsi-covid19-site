...
from_readme:
  ...
  leadForumTags: [{name: msuchard, url: 'https://forums.ohdsi.org/u/msuchard'}, {name: SCYou, url: 'https://forums.ohdsi.org/u/scyou/'}, {name: Conovermitch, url: 'https://forums.ohdsi.org/u/Conovermitch'}]
  startDate: 'March 26, 2020'
  endDate: ""
  protocol: {name: PDF, url: 'https://github.com/ohdsi-studies/Covid19Icarius/blob/master/Documents/COVID19_ACE_ARB_Protocol_Version_1_2.pdf'}
  publications: []
  results: [{name: 'Shiny app', url: 'https://data.ohdsi.org/IcariusSusceptibility/'}]
