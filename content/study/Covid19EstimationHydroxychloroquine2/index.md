...
from_readme:
  title: 'OHDSI COVID-19 Studyathon: Hydroxychloroquine population-level effect estimation 2'
  study_usecase: [1]
  study_type: [0]
  ...
  endDate: ""
  protocol: {name: 'PDF (as filed with PASS)', mainEntityofPage: 'as filed with PASS)](https://github.com/ohdsi-studies/Covid19EstimationHydroxychloroquine2/tree/master/documents'}
  publications: []
  results: [{name: 'Shiny app', mainEntityofPage: 'https://data.ohdsi.org/Covid19EstimationHydroxychloroquine2/'}]
