...
from_readme:
  ...
  leadForumTags: [{name: jenniferlane, url: 'https://forums.ohdsi.org/u/jenniferlane'}, {name: jweave17, url: 'https://forums.ohdsi.org/u/jweave17'}]
  startDate: 'March 26, 2020'
  endDate: ""
  protocol: {name: 'PDF (as filed with PASS)', url: 'as filed with PASS)](https://github.com/ohdsi-studies/Covid19EstimationHydroxychloroquine/blob/master/documents/OHDSI%20COVID-19%20Studyathon_PLE_HCQ_Protocol_v1.4.pdf'}
  publications: []
  results: [{name: 'Shiny app', url: 'https://data.ohdsi.org/Covid19EstimationHydroxychloroquine/'}]
